...
public abstract class AbstractCourse {
    ...
    public final void createCourse(CheckFlag checkFlag, String courseType) {
        //1.上传课件资料
        ...
        //6.检查作业
        chekHomework(checkFlag, courseType);
    }

    private void chekHomework(CheckFlag checkFlag, String courseType) {
        if(checkFlag.getFlag()) {
            System.out.println("检查" + courseType +"作业");
        }
    }
